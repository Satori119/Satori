...
if not _config_path:
    import satori.validator
    _validator_dir = Path(satori.validator.__file__).parent
...
from satori.validator.api import router
...
auto_update = AutoUpdateService(
    github_repo=github_repo or "satori/validator",
...
app = FastAPI(title="SATORI Validator", version="1.0.0", lifespan=lifespan)
