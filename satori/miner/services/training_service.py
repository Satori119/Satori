...
from satori.miner.services.text_training_service import TextTrainingService
from satori.miner.services.image_training_service import ImageTrainingService
