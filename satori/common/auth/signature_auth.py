...
from satori.common.crypto import SignatureAuth
from satori.common.bittensor.client import BittensorClient
from satori.common.utils.logging import setup_logger
from satori.common.services.rate_limiter import RateLimiter
from satori.common.services.nonce_manager import NonceManager
from satori.common.services.hotkey_validator import HotkeyValidator
from satori.common.services.auth_logger import AuthLogger
...
def get_bittensor_client() -> BittensorClient:
    ...
    if _bittensor_client is None:
        try:
            from satori.task_center import shared as task_center_shared
