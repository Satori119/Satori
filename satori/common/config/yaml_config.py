...
class YamlConfig:
    ...
    def get_netuid(self) -> int:
        return self.get('bittensor.netuid', 1)
    
    def get_chain_endpoint(self) -> str:
        return self.get('bittensor.chain_endpoint', 'wss://entrypoint-finney.opentensor.ai:443')
    ...
    def get_min_stake(self) -> float:
        return self.get('miner.min_stake', 200.0)
